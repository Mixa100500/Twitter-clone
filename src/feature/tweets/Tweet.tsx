...
// type TweetHeadWithDotsProps = {
//   name: string
//   username: string
//   dataTime: string
// }
//
// function TweetHeadWithDots (props: TweetHeadWithDotsProps) {
...
//   return (
//     <>
//       <TweetHeader name={props.name} username={props.username} dataTime={props.dataTime}/>
//       <button>
...
// }
//
// type QuotedTweetHeaderProps = TweetHeadWithDotsProps & {
//   profileImage: string
// }
//
// function QuotedTweetHeader (props: QuotedTweetHeaderProps) {
//   const usePlayerStore = usePlayerStoreContext();
//   const isThirdRender = usePlayerStore(state => state.renderCount === 3);
//
//   if(!isThirdRender) {
...
//               <TweetHeadWithDots name={author.name} username={author.username} dataTime={dataTime} />
//             </div>
//             <div>
...
//                   <div className={style.quotedHeaderContainer}>
//                     <QuotedTweetHeader name={referencedAuthor.name} username={referencedAuthor.username} dataTime={referencedDataTime} profileImage={referencedAuthor.profile_image_url} />
//                   </div>
//                   <div className={style.articleBody}>
...
//           <article className={style.article}>
//             <div className={style.headerContainer}>
//               <TweetHeadWithDots name={ref.author.name} username={ref.author.username} dataTime={dataTime} />
//             </div>
//             <div className={style.articleBody}>
